...
public class Stage3BossGhost extends Enemy //縦に落ちてくるだけの敵
{
    ...
    Stage3BossGhost(ImageView texture, float posX, float moveX, float moveY, int delayTime, int index, float speed, float weight) {
