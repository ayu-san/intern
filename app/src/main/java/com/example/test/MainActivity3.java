...
public class MainActivity3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        boxes = new ArrayList<>();
        boxes.add(new Box(findViewById(R.id.box),screenWidth /2 - 100.0f, screenHeight /2));
        boxes.add(new Box(findViewById(R.id.box1),500.0f, 300.0f));
                    ...
                    {
                        {
                            ...
                            boxes.get(0).CollisionwithPlayer(player,boxes.get(k),collideEffect,screenWidth,drawable);
                        }
                    }
...
//                    boxes.get(0).CollisionwithPlayer(player,boxes,collideEffect,screenWidth);
                    ...
                    //Player player, ArrayList<Box> boxes, CollideEffect effect, int screenWidth, Drawable drawable
                    if (i <= upSize - 1) {
    ...
    public void showLevelUp(){
        ...
        noselect.setOnClickListener(view -> {
            ...
            timer.schedule(new TimerTask() {
                @Override
                public void run() {
                    handler.post(MainActivity3.this::Update);
                }
            }, 0, 16);
